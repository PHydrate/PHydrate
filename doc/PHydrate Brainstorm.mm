...
<node CREATED="1286920296730" ID="ID_1554658980" MODIFIED="1287162686857" TEXT="[References(typeof(T), LazyLoad = true)]">
...
<node CREATED="1287162728127" ID="ID_1952777490" MODIFIED="1287162861035" TEXT="[DictionaryOf(typeof(T)]">
<node CREATED="1287162770534" ID="ID_617416769" MODIFIED="1287162775793" TEXT="One-to-many"/>
<node CREATED="1287162776252" ID="ID_443483236" MODIFIED="1287172653597" TEXT="member type should be IDictionary&lt;TKey, T&gt;">
<node CREATED="1287162873047" ID="ID_1585066255" MODIFIED="1287162880719" TEXT="TKey should be determined from the metadata on T"/>
<node CREATED="1287162815355" ID="ID_176558652" MODIFIED="1287162827741" TEXT="How do we deterimine the key to be used?">
<node CREATED="1287162828825" ID="ID_1752410176" MODIFIED="1287162851981" TEXT="The [UniqueIdentifier]?"/>
</node>
</node>
<node CREATED="1287172655099" ID="ID_1090759419" MODIFIED="1287172680630" TEXT="Since we are using metadata to figure out TKey, we might be able to use [CollectionOf] for both types..."/>
</node>
...
<node CREATED="1286984810308" ID="ID_580667733" MODIFIED="1287172614068" TEXT="Interface design options">
