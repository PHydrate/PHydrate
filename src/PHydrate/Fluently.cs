...
namespace PHydrate
{
    ...
    /// <example>
    /// <code lang="C#">
    /// <see cref="ISessionFactory"/> sessionFactory = <see cref="Fluently"/>.Configure.DatabaseProvider(new <see cref="SqlServerDatabaseService"/>(...)).ParameterPrefix("@").BuildSessionFactory();
    /// </code>
    /// </example>
    /// </remarks>
