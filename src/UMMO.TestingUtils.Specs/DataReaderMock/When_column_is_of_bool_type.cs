...
namespace UMMO.TestingUtils.Specs.DataReaderMock
{
    ...
    {
        private static readonly bool BooleanValue = A.Random.Boolean;
        private Because Of = () => SetupTestRecord( BooleanValue );

        private It Should_return_boolean_when_getdatatypename_is_called
        ...
        private It Should_return_typeof_boolean_when_getfieldtype_is_called
