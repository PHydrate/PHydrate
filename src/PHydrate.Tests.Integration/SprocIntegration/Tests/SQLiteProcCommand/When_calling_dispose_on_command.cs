...
namespace PHydrate.Tests.Integration.SprocIntegration.Tests.SQLiteProcCommand
{
    ...
    public sealed class When_calling_dispose_on_command : SQLiteProcCommandSpecificationBase
    {
        private Establish Context = () => BaseCommand.Expect( x => x.Dispose() );

        private Because Of = () => ProcCommand.Dispose();
