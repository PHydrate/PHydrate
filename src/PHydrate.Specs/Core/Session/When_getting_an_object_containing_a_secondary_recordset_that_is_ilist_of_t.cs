...
namespace PHydrate.Specs.Core.Session
{
    ...
    public sealed class When_getting_an_object_containing_a_secondary_recordset_that_is_ilist_of_t :
        SessionSpecificationHydrateWithSecondaryRecordsetEnumerableBase
    {
        private Because Of =
            () =>
            _requestedObjects =
            SessionUnderTest.Get< TestObjectSecondaryRecordsetIList >( x => x.AggregateKey == 1 ).ToList();
