...
namespace PHydrate.Specs.Attributes.MeansImplicitUse
{
    ...
    public class When_instantiating_means_implicit_use_attribute_with_default_constructor
    {
        private static MeansImplicitUseAttribute _expectedAttribute;
        private Because Of = () => _expectedAttribute = new MeansImplicitUseAttribute();
