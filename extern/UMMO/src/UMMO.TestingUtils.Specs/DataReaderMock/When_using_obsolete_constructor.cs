...
#pragma warning disable 612,618
        private Because Of = () => MockUnderTest = new TestingUtils.DataReaderMock( RecordSet );
#pragma warning restore 612,618

        private It Should_return_an_object_ready_for_playback
            = () => typeof(InvalidOperationException).ShouldBeThrownBy( () => MockUnderTest.AddRecordSet( "" ) );

        private It Should_contain_records_with_two_columns
